 ...
 *
 */
public class M2mRecordReader {

    private M2mInputArchive archive;
    ...
    static {
        ...
        try {
            archiveFactory.put("binary", M2mBinaryInputArchive.class
                    .getDeclaredMethod("getArchive", params));
            archiveFactory.put("csv", M2mCsvInputArchive.class
                    .getDeclaredMethod("getArchive", params));
            archiveFactory.put("xml", M2mXmlInputArchive.class
                    .getDeclaredMethod("getArchive", params));
    ...
    static private M2mInputArchive createArchive(InputStream in, String format)
            throws IOException {
        Method factory = (Method) archiveFactory.get(format);
        if (factory != null) {
            Object[] params = { in };
            try {
                return (M2mInputArchive) factory.invoke(null, params);
     ...
     */
    public M2mRecordReader(InputStream in, String format) throws IOException {
     ...
     */
    public void read(M2mRecord r) throws IOException {
