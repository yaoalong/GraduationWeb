 ...
 *
 */
public class M2mCsvOutputArchive implements M2mOutputArchive {

    private PrintStream stream;
    private boolean isFirst = true;
    
    static M2mCsvOutputArchive getArchive(OutputStream strm)
    throws UnsupportedEncodingException {
        return new M2mCsvOutputArchive(strm);
    }
    ...
    public M2mCsvOutputArchive(OutputStream out)
    throws UnsupportedEncodingException {
