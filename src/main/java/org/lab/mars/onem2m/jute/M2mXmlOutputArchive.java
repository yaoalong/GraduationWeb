 ...
 *
 */
public class M2mXmlOutputArchive implements M2mOutputArchive {
    ...
    static M2mXmlOutputArchive getArchive(OutputStream strm) {
        return new M2mXmlOutputArchive(strm);
    }
    
    /** Creates a new instance of XmlOutputArchive */
    public M2mXmlOutputArchive(OutputStream out) {
